...
/// Logged-in salesman ki apni sale invoices — read-only history, "New Sale"
/// nav item se hi nayi invoice banti hai.
      ...
      body: RefreshIndicator(
        ...
        child: salesAsync.when(
          ...
          data: (sales) {
            ...
            final commission =
                sales.fold<double>(0, (s, i) => s + i.salesmanCommissionAmount);
        ...
        ...sales.asMap().entries.map((e) {
          ...
          return Container(
            ...
            child: Row(children: [
              ...
              _cell(s.salesmanCommissionAmount.toStringAsFixed(0),
                  flex: 2,
                  style: const TextStyle(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    _stat('My Commission',
                        s.salesmanCommissionAmount.toStringAsFixed(0),
