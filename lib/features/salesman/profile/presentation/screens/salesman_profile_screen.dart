...
import '../providers/salesman_profile_provider.dart';

import 'package:safishoe_app/core/widget/app_icon.dart';
import 'package:safishoe_app/core/constants/app_icons.dart';

class SalesmanProfileScreen extends ConsumerWidget {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          ...
          await ref.read(salesmanProfileProvider.future);
        },
                    ...
                    return const Padding(
                      ...
                      child: Center(
                        child: Text(
                          ...
                          'Apne manager ya admin se rabta karein.',
...
class _SalaryHistoryCard extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final historyAsync = ref.watch(salesmanSalaryHistoryProvider);
