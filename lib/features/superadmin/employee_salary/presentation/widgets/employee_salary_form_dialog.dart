...
class _EmployeeSalaryFormDialogState
  ...
  Widget _buildUserDropdown(List<UserModel> users) {
    ...
    return AppSearchDropdown<UserModel>(
      ...
      prefixIcon: const TextFieldIcon(AppIcons.personOutline, size: 12),
  ...
  Widget _buildBranchDropdown(List<BranchModel> branches) {
    ...
    return AppSearchDropdown<BranchModel>(
      ...
      prefixIcon: const TextFieldIcon(AppIcons.storeOutlined, size: 12),
  ...
  Widget _buildField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: TextFieldIcon(icon, size: 12, color: const Color(0xFF8A8FA3)),
        isDense: true,
        contentPadding:
