...
class SaleSummaryReportScreen extends ConsumerWidget {
                    ...
                    : SingleChildScrollView(
                        child: ReportTableShell(
                          ...
                          rows: state.transactions
                              .map((t) => DataRow(cells: [
                                    DataCell(_TypeBadge(type: t.type, color: _rowColor(t.type))),
                                    ...
                                    DataCell(Text(
                                      ...
                                      style: TextStyle(
                                          fontWeight: FontWeight.w700, color: _rowColor(t.type)),
                                    )),
                                  ]))
                              .toList(),
                        ),
