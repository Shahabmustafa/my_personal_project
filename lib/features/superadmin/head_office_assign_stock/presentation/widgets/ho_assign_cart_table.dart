...
class HoAssignCartTable extends ConsumerWidget {
  const HoAssignCartTable({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final items = ref.watch(hoAssignStockProvider).cartItems;
...
class _DesktopTable extends ConsumerWidget {
  final List<HoAssignCartItem> items;
...
class _AssignRowState extends ConsumerState<_AssignRow> {
  ...
  Widget build(BuildContext context) {
    ...
    final notifier = ref.read(hoAssignStockProvider.notifier);
