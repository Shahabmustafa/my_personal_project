                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          Expanded(
                            ...
                            child: AppSearchDropdown<StockLookupItem>(
                              ...
                              itemLabel: (c) => c.label,
                              prefixIcon: const TextFieldIcon(
                                  AppIcons.businessOutlined, size: 18),
                          ...
                          Expanded(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                labelText: 'Discount %',
                                prefixIcon: const TextFieldIcon(
                                    AppIcons.percentOutlined, size: 18),
                      ...
                      Row(children: [
                        ...
                        Expanded(
                          child: AppSearchDropdown<StockLookupItem>(
                            ...
                            isRequired: true,
                            prefixIcon: const TextFieldIcon(AppIcons.categoryOutlined, size: 18),
                            onChanged: (c) => setState(() {
                              _category = c;
                              _previewed = false;
                            }),
                      ...
                      AppSearchDropdown<StockLookupItem>(
                        ...
                        isRequired: true,
                        prefixIcon: const TextFieldIcon(AppIcons.styleOutlined, size: 18),
      ...
      children: [
        ...
        Expanded(
          ...
          child: AppSearchDropdown<StockLookupItem>(
            ...
            itemLabel: (s) => s.label,
            isRequired: true,
            prefixIcon: const TextFieldIcon(AppIcons.formatSizeOutlined, size: 18),
