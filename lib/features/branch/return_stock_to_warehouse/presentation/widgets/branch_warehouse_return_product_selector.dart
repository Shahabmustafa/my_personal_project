...
class BranchWarehouseReturnProductSelector extends ConsumerStatefulWidget {
  const BranchWarehouseReturnProductSelector({super.key});

  @override
  ConsumerState<BranchWarehouseReturnProductSelector> createState() =>
      _BranchWarehouseReturnProductSelectorState();
}

class _BranchWarehouseReturnProductSelectorState
    extends ConsumerState<BranchWarehouseReturnProductSelector> {
