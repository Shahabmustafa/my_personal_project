...
class BranchWarehouseReturnCartTable extends ConsumerWidget {
  const BranchWarehouseReturnCartTable({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final items = ref.watch(branchWarehouseReturnProvider).cartItems;
...
class _DesktopTable extends ConsumerWidget {
  final List<BranchWarehouseReturnCartItem> items;
...
class _CartRow extends ConsumerWidget {
  final BranchWarehouseReturnCartItem item;
  final int index;
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final notifier = ref.read(branchWarehouseReturnProvider.notifier);
