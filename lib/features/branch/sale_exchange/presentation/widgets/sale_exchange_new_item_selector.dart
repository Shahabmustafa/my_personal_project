...
class SaleExchangeNewItemSelector extends ConsumerStatefulWidget {
  const SaleExchangeNewItemSelector({super.key});

  @override
  ConsumerState<SaleExchangeNewItemSelector> createState() =>
      _SaleExchangeNewItemSelectorState();
}

class _SaleExchangeNewItemSelectorState extends ConsumerState<SaleExchangeNewItemSelector> {
  ...
  void _addToCart() {
    ...
    final added = ref
        ...
        .addNewCartItem(stock, quantity: requested > 0 ? requested : 1);
