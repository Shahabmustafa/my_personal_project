...
class _BranchAssignListScreenState
  ...
  Widget build(BuildContext context) {
    ...
    final pendingCount = listState.assignments
...
const _colFlex = <int>[1, 3, 5, 2, 3, 2, 2, 3, 4];
            ...
            Expanded(
              child: ListView.separated(
                ...
                separatorBuilder: (_, __) =>
                    const Divider(height: 1, color: Color(0xFFEEF0F6)),
                itemBuilder: (context, i) => _row(context, ref, rows[i], i),
              ),
            ),
          ],
        ),
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(flex: _colFlex[5], child: Text('${a.items.length}')),
            Expanded(flex: _colFlex[6], child: Text('$qty')),
            Expanded(
              flex: _colFlex[7],
              child: FittedBox(
...
/// Assignment ka source type (Head Office / Warehouse / Branch) — apna
/// alag column, "Assigned By" naam ke sath mix nahi hota.
class _SourceTypeTag extends StatelessWidget {
  final AssignStockModel a;
  const _SourceTypeTag({required this.a});
  ...
  Widget build(BuildContext context) {
    ...
    switch (a.sourceType) {
      ...
      case 'branch':
        ...
        break;
      default:
        return const Text('—', style: TextStyle(color: Color(0xFF8A8FA3)));
    }
    return Align(
      alignment: Alignment.centerLeft,
      child: Container(
  ...
  Widget build(BuildContext context) => Center(
    child: Column(
      ...
      children: [
        ...
        const Text(
          'When stock is assigned to your branch, it shows up here.',
