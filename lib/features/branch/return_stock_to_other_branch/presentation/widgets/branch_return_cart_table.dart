...
class BranchReturnCartTable extends ConsumerWidget {
  const BranchReturnCartTable({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final items = ref.watch(branchStockReturnProvider).cartItems;
...
class _DesktopTable extends ConsumerWidget {
  final List<BranchReturnCartItem> items;
...
class _CartRow extends ConsumerWidget {
  final BranchReturnCartItem item;
  final int index;
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final notifier = ref.read(branchStockReturnProvider.notifier);
