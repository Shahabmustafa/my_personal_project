...
/// Sale Invoice ke [SaleProductSelector] jaisa hi — ek hi searchable
/// "Article" dropdown, har entry ek exact stock variant (color/size/
/// category/type ke sath). Return ke liye: koi stock-quantity cap nahi
/// (jitni bhi qty return karni ho utni allowed hai) aur qty>0 filter nahi
/// (0-stock SKU bhi return ho sakti hai).
