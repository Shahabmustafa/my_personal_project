...
/// SaleExchangeReturnItemsPicker jaisa — sirf accent color red hai.
class SaleReturnItemsPicker extends ConsumerWidget {
  const SaleReturnItemsPicker({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final items = ref.watch(saleReturnProvider).invoiceReturnItems;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ...items.map((item) => _ReturnItemRow(item: item, accent: accent)),
        ],
      ),
    );
  }
...
class _ReturnItemRow extends ConsumerWidget {
  ...
  final Color accent;
  const _ReturnItemRow({required this.item, required this.accent});
